        ...
        <div className="grid md:grid-cols-3 gap-4">
          <Card>
            <CardContent className="p-6 text-center">
              <p className="text-3xl font-display font-bold text-foreground">{mockAtendentes.length}</p>
              <p className="text-xs text-muted-foreground font-body mt-1">Total de Atendentes</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-xs text-muted-foreground font-body mt-1">Em Atendimento</p>
            </CardContent>
          </Card>
          <Card>
            <CardContent className="p-6 text-center">
              ...
              <p className="text-xs text-muted-foreground font-body mt-1">Concluídos</p>
            </CardContent>
          </Card>
        </div>
              ...
              <CardContent className="p-5">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      <p className="font-body font-semibold text-foreground">{a.nome}</p>
